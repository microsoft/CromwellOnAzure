...
az network vnet peering create --name HubToSpoke0 --resource-group $resource_group_name --vnet-name $hub_vnet_name --remote-vnet  $spoke_vnet_name --allow-vnet-access
az network vnet peering create --name Spoke0ToHub --resource-group $resource_group_name --vnet-name $spoke_vnet_name --remote-vnet $hub_vnet_name --allow-vnet-access
...
az network private-dns link vnet create --resource-group $resource_group_name --zone-name $dns_zone_name --name "${spoke_vnet_name}-dns-link" --virtual-network $spoke_vnet_name --registration-enabled false
