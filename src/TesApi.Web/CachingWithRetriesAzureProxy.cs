...
namespace TesApi.Web
{
    ...
    public class CachingWithRetriesAzureProxy : IAzureProxy
    {
        ...
        /// <inheritdoc/>
        public Task<bool> CreateManualBatchPoolAsync(string poolName, string vmSize, bool isLowPriority, string executorImage, BatchNodeInfo nodeInfo, string dockerInDockerImageName, string blobxferImageName, IEnumerable<string> identityResourceIds, bool disableBatchNodesPublicIpAddress, string batchNodesSubnetId, string startTaskSasUrl, string startTaskPath)
