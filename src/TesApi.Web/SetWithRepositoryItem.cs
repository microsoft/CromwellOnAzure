...
namespace TesApi.Web
{
    ...
    public class GroupablSetWithRepositoryElements<TElement, TRepositoryItem> : GroupableSet<TElement>, ISet<TElement> where TElement : IHasRepositoryItem<TRepositoryItem> where TRepositoryItem : RepositoryItem<TRepositoryItem>
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupablSetWithRepositoryElements{TElement, TRepositoryItem}"/> class that is empty and uses the default equality comparer for the set type.
        /// </summary>
        public GroupablSetWithRepositoryElements() : base() { }

        /// <summary>
        /// Initializes a new instance of the <see cref="GroupablSetWithRepositoryElements{TElement, TRepositoryItem}"/> class that uses the default equality comparer for the set type, contains elements copied from the specified collection, and has sufficient capacity to accommodate the number of elements copied.
        /// </summary>
        /// <param name="collection">The collection whose elements are copied to the new set.</param>
        /// <exception cref="ArgumentNullException">collection is null.</exception>
        public GroupablSetWithRepositoryElements(IEnumerable<TElement> collection) : base(collection) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="GroupablSetWithRepositoryElements{TElement, TRepositoryItem}"/> class that is empty and uses the specified equality comparer for the set type.
        /// </summary>
        /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing values in the set, or null to use the default <see cref="IEqualityComparer{T}"/> implementation for the set type.</param>
        public GroupablSetWithRepositoryElements(IEqualityComparer<TElement> comparer) : base(comparer) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="GroupablSetWithRepositoryElements{TElement, TRepositoryItem}"/> class that uses the specified equality comparer for the set type, contains elements copied from the specified collection, and has sufficient capacity to accommodate the number of elements copied.
        /// </summary>
        /// <param name="collection">The collection whose elements are copied to the new set.</param>
        /// <param name="comparer">The <see cref="IEqualityComparer{T}"/> implementation to use when comparing values in the set, or null to use the default <see cref="IEqualityComparer{T}"/> implementation for the set type.</param>
        public GroupablSetWithRepositoryElements(IEnumerable<TElement> collection, IEqualityComparer<TElement> comparer) : base(collection, comparer) { }
        #endregion
