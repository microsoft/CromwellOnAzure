    ...
    public class IntegrationTests
    {
        ...
        public async Task RunAllCommonWorkflowsWaitTilDoneAsync()
        {
            ...
            [
                ...
                // Docker image manifest is old ("https://raw.githubusercontent.com/microsoft/gatk4-rnaseq-germline-snps-indels-azure/jsaun/gatk4-rna-germline-variant-calling.trigger.json", "rna-germline"),
