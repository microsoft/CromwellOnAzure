...
bool     KeepSshPortOpen =   false; | Y | Y | Y | Available starting version 2.5. Set to true if you need to keep the SSH port accessible on the host VM while deployer is not running (not recommended). 
